...
ava('Intrinsic FnGetAtt should generate JSON correctly', test => {
...
ava('Intrinsic FnGetAtt within a Resource', test => {
  let t = new wk.Template();
  ...
  rule1.FromPort = 80;
  rule1.ToPort = 80;
  rule1.SourceSecurityGroupOwnerId = new wk.Intrinsic.FnGetAtt(
    ElasticLoadBalancer.getName(),
    'SourceSecurityGroup.OwnerAlias'
  );
  rule1.SourceSecurityGroupName = new wk.Intrinsic.FnGetAtt(
    ElasticLoadBalancer.getName(),
  ...
  rule2.FromPort = 8004;
  rule2.ToPort = 8004;
  rule2.SourceSecurityGroupOwnerId = new wk.Intrinsic.FnGetAtt(
    ElasticLoadBalancer.getName(),
    'SourceSecurityGroup.OwnerAlias'
  );
  rule2.SourceSecurityGroupName = new wk.Intrinsic.FnGetAtt(
    ElasticLoadBalancer.getName(),
    'SourceSecurityGroup.GroupName'
  );
  ...
  rule3.FromPort = 443;
  rule3.ToPort = 443;
  rule3.SourceSecurityGroupOwnerId = new wk.Intrinsic.FnGetAtt(
    ElasticLoadBalancer.getName(),
    'SourceSecurityGroup.OwnerAlias'
  );
  rule3.SourceSecurityGroupName = new wk.Intrinsic.FnGetAtt(
    ElasticLoadBalancer.getName(),
    'SourceSecurityGroup.GroupName'
  );
