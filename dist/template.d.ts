...
import { IFnAnd, IFnBase64, IFnEquals, IFnFindInMap, IFnGetAtt, IFnGetAZs, IFnIf, IFnJoin, IFnNot, IFnOr, IFnSelect, IFnSplit, IFnSub, IRef } from './intrinsic';
/** @module Template */
/**
 * Template Interface
 * @member Template
...
export declare function _json(t: IElement | IFnAnd | IFnBase64 | IFnFindInMap | IRef | IFnGetAtt | IFnGetAZs | IFnJoin | IFnSelect | IFnSplit | IFnSub | ICreationPolicy | IDeletionPolicy | IDependsOn | IFnEquals | IFnIf | IFnNot | IFnOr | IResourceMetadata | IUpdatePolicy): any;
