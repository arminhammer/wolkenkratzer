...
* @property {AppCookieStickinessPolicyobjects} AppCookieStickinessPolicy Required: No. Generates one or more stickiness policies with sticky session lifetimes that
...
* @property {LBCookieStickinessPolicyobjects} LBCookieStickinessPolicy Required: No. Generates a stickiness policy with sticky session lifetimes controlled by the
...
* @property {ElasticLoadBalancingListenerPropertyTypeobjects} Listeners Required: Yes. One or more listeners for this load balancer. Each listener must be registered
...
* @property {ElasticLoadBalancingpolicyobjects} Policies Required: No. A list of elastic load balancing policies to apply to this elastic load balancer. Specify only back-end server policies. For more information, see DescribeLoadBalancerPolicyTypes in the Elastic Load Balancing API Reference.Update requires: No interruption
...
* @property {securitygroupsassignedtoyourloadbalancerwithinyourvirtualprivatecloud(VPC)} SecurityGroups Required: No. Update requires: No interruption
