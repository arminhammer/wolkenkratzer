...
* @property NoDevice {Boolean} Required: No. Suppresses the device mapping. If NoDevice is set to true for the
...
* @property VirtualName {String} Required: Conditional. The name of the virtual device. The name must be in the form
                        ephemeralX
...
/** 
* @property DeleteOnTermination {Boolean} Required: No. Indicates whether to delete the volume when the instance is terminated. By
                  default, Auto Scaling uses true.
* @property Encrypted {Boolean} Required: No. Indicates whether the volume is encrypted. Encrypted EBS volumes must be
                  ...
                  snapshot.
* @property Iops {Number} Required: No. The number of I/O operations per second (IOPS) that the volume supports. The
...
* @property VolumeSize {Number} Required: Conditional. The volume size, in Gibibytes (GiB). This can be a number from 1 – 1024.
                  If the volume type is EBS optimized, the minimum value is 10. For more information
                  about specifying the volume type, see EbsOptimized in AWS::AutoScaling::LaunchConfiguration.Update requires: Some interruptions
* @property VolumeType {String} Required: No. The volume type. By default, Auto Scaling uses the standard volume type.
...
/** 
* @property Granularity {String} Required: Yes. The frequency at which Auto Scaling sends aggregated data to CloudWatch. For example, you can
                  specify 1Minute to send aggregated data to CloudWatch every minute.
* @property Metrics {String} Required: No. The list of metrics to collect. If you don't specify any metrics, all metrics
                  are enabled.
*/
...
/** 
* @property NotificationTypes {String} Required: Yes. A list of event types that trigger a notification. Event types can include any
...
* @property TopicARN {String} Required: Yes. The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (SNS)
                  topic.
*/
...
/** 
* @property MetricIntervalLowerBound {Number} Required: No. The lower bound for the difference between the breach threshold and the CloudWatch
                  metric. If the metric value exceeds the breach threshold, the lower bound is
                  inclusive (the metric must be greater than or equal to the threshold plus the
                  lower bound). Otherwise, it is exclusive (the metric must be greater than the
                  threshold plus the lower bound). A null value indicates negative infinity.
* @property MetricIntervalUpperBound {Number} Required: No. The upper bound for the difference between the breach threshold and the CloudWatch
                  metric. If the metric value exceeds the breach threshold, the upper bound is
...
* @property ScalingAdjustment {Number} Required: Yes. The amount by which to scale, based on the value that you specified in the
                     AdjustmentType property. A positive value adds to the current
...
* @property PropagateAtLaunch {Boolean} Required: Yes. Set to true if you want AWS CloudFormation to copy the tag to EC2 instances that are launched as
...
/** 
* @property default {String} Required: No. The default label that the AWS CloudFormation console uses to name a parameter group or
                  parameter.
*/
...
* @property Parameters {String} Required: No. A list of case-sensitive parameter logical IDs to include in the group.
...
/** 
* @property ParameterLogicalID {AWSCloudFormationInterfaceLabel} Required: No. A label for a parameter. The label defines a friendly name or description that
...
* @property CustomErrorResponses {CloudFrontDistributionConfigCustomErrorResponse} Required: No. Whether CloudFront replaces HTTP status codes in the 4xx and
                     5xx range with custom error messages before returning the response
                  to the viewer.
* @property DefaultCacheBehavior {CloudFrontDefaultCacheBehavior} Required: Yes. The default cache behavior that is triggered if you do not specify the
                     CacheBehavior property or if files don't match any of the values
                  of PathPattern in the CacheBehavior property.
* @property DefaultRootObject {String} Required: No. The object (such as index.html) that you want CloudFront to request from
...
* @property Logging {CloudFrontLogging} Required: No. Controls whether access logs are written for the distribution. To turn on
                  access logs, specify this property.
* @property Origins {CloudFrontDistributionConfigOrigin} Required: Yes. A list of origins for this CloudFront distribution. For each origin, you can specify
                  whether it is an Amazon S3 or custom origin.
* @property PriceClass {String} Required: No. The price class that corresponds with the maximum price that you want to pay
                  for the CloudFront service. For more information, see Choosing the Price Class in the
                     Amazon CloudFront Developer Guide.For more information about the constraints and valid values, see the PriceClass element for the DistributionConfig Complex Type data type in the Amazon CloudFront API Reference.
...
* @property WebACLId {String} Required: No. The AWS WAF web ACL to associate
...
/** 
* @property AllowedMethods {String} Required: No. HTTP methods that CloudFront processes and forwards to your Amazon S3 bucket or your
                  custom origin. You can specify ["HEAD", "GET"], ["GET", "HEAD",
                     ...
                     ["HEAD", "GET"].
* @property CachedMethods {String} Required: No. HTTP methods for which CloudFront caches responses. You can specify ["HEAD",
                     "GET"] or ["GET", "HEAD", "OPTIONS"]. If you don't specify
                  a value, AWS CloudFormation specifies ["HEAD", "GET"].
* @property Compress {Boolean} Required: No. Indicates whether CloudFront automatically compresses certain files for this cache
                  behavior. For more information, see Serving Compressed Files
                  in the Amazon CloudFront Developer Guide.
* @property DefaultTTL {Number} Required: No. The default time in seconds that objects stay in CloudFront caches before CloudFront
...
* @property MaxTTL {Number} Required: No. The maximum time in seconds that objects stay in CloudFront caches before CloudFront forwards
...
* @property MinTTL {Number} Required: No. The minimum amount of time that you want objects to stay in the cache before
                  CloudFront queries your origin to see whether the object has been updated.
* @property PathPattern {String} Required: Yes. The pattern to which this cache behavior applies. For example, you can specify
                  ...
                  template.
* @property SmoothStreaming {Boolean} Required: No. Indicates whether to use the origin that is associated with this cache behavior
...
* @property TargetOriginId {String} Required: Yes. The ID value of the origin to which you want CloudFront to route requests when a
                  request matches the value of the PathPattern property.
* @property TrustedSigners {String} Required: No. A list of AWS accounts that can create signed URLs in order to access private
                  content.
* @property ViewerProtocolPolicy {String} Required: Yes. The protocol that users can use to access the files in the origin that you
                  ...
                  valid values, see the ViewerProtocolPolicy elements in the DistributionConfig Complex Type topic in the
...
/** 
* @property ErrorCachingMinTTL {Number} Required: No. The minimum amount of time, in seconds, that Amazon CloudFront caches the HTTP status code
                  that you specified in the ErrorCode property. The default value is
                     300.
* @property ErrorCode {Number} Required: Yes. An HTTP status code for which you want to specify a custom error page. You can
                  specify 400, 403, 404, 405,
                     414, 500, 501, 502,
                     503, or 504.
* @property ResponseCode {Number} Required: Conditional. The HTTP status code that CloudFront returns to viewer along with the custom error
                  page. You can specify 200, 400, 403,
                     404, 405, 414, 500,
                     501, 502, 503, or
                  504.
* @property ResponsePagePath {String} Required: Conditional. The path to the custom error page that CloudFront returns to a viewer when your
...
* @property AllowedMethods {String} Required: No. HTTP methods that CloudFront processes and forwards to your Amazon S3 bucket or your
                  ...
                  specifies ["HEAD", "GET"].
* @property CachedMethods {String} Required: No. HTTP methods for which CloudFront caches responses. In AWS CloudFormation templates, you can
...
* @property DefaultTTL {Number} Required: No. The default time in seconds that objects stay in CloudFront caches before CloudFront
                  ...
                  the minimum Time To Live (TTL) value.
* @property ForwardedValues {CloudFrontForwardedValues} Required: Yes. Specifies how CloudFront handles query strings or cookies.
* @property MaxTTL {Number} Required: No. The maximum time in seconds that objects stay in CloudFront caches before CloudFront
                  forwards another request to your custom origin to determine whether the object has
                  been updated. This value applies only when your custom origin does not add HTTP
                  headers, such as Cache-Control max-age, Cache-Control
...
* @property MinTTL {String} Required: No. The minimum amount of time that you want objects to stay in the cache before
                  CloudFront queries your origin to see whether the object has been updated.
* @property SmoothStreaming {Boolean} Required: No. Indicates whether to use the origin that is associated with this cache behavior
                  to distribute media files in the Microsoft Smooth Streaming format.
* @property TargetOriginId {String} Required: Yes. The value of ID for the origin that CloudFront routes requests to when the default
...
* @property ViewerProtocolPolicy {String} Required: Yes. The protocol that users can use to access the files in the origin that you
                  ...
                  behavior is applied to a request. For valid values, see the
                     ViewerProtocolPolicy element of the DistributionConfig Complex Type in the
                     Amazon CloudFront API Reference.
*/
...
/** 
* @property Bucket {String} Required: Yes. The Amazon S3 bucket address where access logs are stored, for example,
...
* @property DomainName {String} Required: Yes. The DNS name of the Amazon Simple Storage Service (S3) bucket or the HTTP server from which you want
                  CloudFront to get objects for this origin.
* @property Id {String} Required: Yes. An identifier for the origin. The value of Id must be unique
                  within the distribution.
* @property OriginPath {String} Required: No. The path that CloudFront uses to request content from an S3 bucket or custom origin.
...
/** 
* @property OriginAccessIdentity {String} Required: No. The CloudFront origin access identity to associate with the origin. This is used to
...
/** 
* @property Locations {String} Required: Conditional. The two-letter, uppercase country code for a country that you want to include
                  in your blacklist or whitelist.
* @property RestrictionType {String} Required: Yes. The method to restrict distribution of your content:Prevents viewers in the countries that you specified from accessing
...
* @property blacklist {undefined} Required: undefined. Prevents viewers in the countries that you specified from accessing
                              your content.
* @property whitelist {undefined} Required: undefined. Allows viewers in the countries that you specified to access your
                              content.
...
/** 
* @property CloudFrontDefaultCertificate {Boolean} Required: Conditional. Indicates whether to use the default certificate for your CloudFront domain name when
...
* @property MinimumProtocolVersion {String} Required: Conditional. The minimum version of the SSL protocol that you want CloudFront to use for HTTPS
                  connections. CloudFront serves your objects only to browsers or devices that support at
                  least the SSL version that you specify.If you specify the IamCertificateId property and specify SNI only
                  for the SslSupportMethod property, you must use TLSv1
                  for the minimum protocol version. If you don't specify a value, AWS CloudFormation specifies
                     SSLv3.
...
* @property Headers {String} Required: No. Specifies the headers that you want Amazon CloudFront to forward to the origin for this
                  ...
                  values in viewer requests.If you specify a single asterisk (["*"]), all headers are
                  forwarded. If you don't specify a value, only the default headers are
                  forwarded.
* @property QueryString {Boolean} Required: Yes. Indicates whether you want CloudFront to forward query strings to the origin that is
...
/** 
* @property Forward {String} Required: Yes. The cookies to forward to the origin of the cache behavior. You can specify
...
/** 
* @property MetricName {String} Required: Yes. The name of the CloudWatch metric to which the log information will be
                  published.
* @property MetricNamespace {String} Required: Yes. The destination namespace of the CloudWatch metric. Namespaces are containers for
                  metrics. For example, you can add related metrics in the same namespace.
* @property MetricValue {String} Required: Yes. The value that is published to the CloudWatch metric. For example, if you're counting
...
/** 
* @property Type {String} Required: No. The type of count to use, such as an absolute value or a percentage of the
...
* @property IgnoreApplicationStopFailures {Boolean} Required: No. Whether to continue the deployment if the
...
/** 
* @property GitHubLocation {AWSCodeDeployDeploymentGroupDeploymentRevisionGitHubLocation} Required: No. If your application revision is stored in GitHub, information about the
                  location where it is stored.
* @property RevisionType {String} Required: No. The application revision's location, such as in an S3 bucket or GitHub
                  repository. For valid values, see RevisionLocation in the
                     AWS CodeDeploy API Reference.
* @property S3Location {AWSCodeDeployDeploymentGroupDeploymentRevisionS3Location} Required: No. If the application revision is stored in an S3 bucket, information about the
                  location.
*/
...
/** 
* @property CommitId {String} Required: Yes. The SHA1 commit ID of the GitHub commit to use as your application
                  revision.
* @property Repository {String} Required: Yes. The GitHub account and repository name that includes the application revision.
...
* @property BundleType {String} Required: Yes. The file type of the application revision, such as tar,
                     tgz, or zip. For valid values, see S3Location in the
                     AWS CodeDeploy API Reference.
* @property ETag {String} Required: No. The Amazon S3 ETag (a file checksum) of the application revision. If you don't
...
* @property Version {String} Required: No. For versioning-enabled buckets, a specific version of the application
                  revision.
*/
...
* @property Type {String} Required: Yes. The filter type. For example, you can filter instances by the key, tag value,
...
* @property Type {String} Required: No. The filter type. For example, you can filter on-premises instances by the key,
...
/** 
* @property Description {String} Required: No. A description of this configuration property that will be displayed to
                  users.
...
* @property Queryable {Boolean} Required: No. Indicates whether the configuration property will be used with the
...
* @property Secret {Boolean} Required: Yes. Indicates whether the configuration property is secret. Secret configuration
...
* @property Type {String} Required: No. The type of the configuration property, such as String,
                     Number, or Boolean.
*/
...
/** 
* @property EntityUrlTemplate {String} Required: No. The URL that is returned to the AWS CodePipeline console that links to the resources of
                  the external system, such as the configuration page for an AWS CodeDeploy deployment
                  group.
* @property ExecutionUrlTemplate {String} Required: No. The URL that is returned to the AWS CodePipeline console that links to the top-level
                  landing page for the external system, such as the console page for AWS CodeDeploy.
* @property RevisionUrlTemplate {String} Required: No. The URL that is returned to the AWS CodePipeline console that links to the page where
                  customers can update or change the configuration of the external action.
* @property ThirdPartyConfigurationUrl {String} Required: No. The URL of a sign-up page where users can sign up for an external service and
...
/** 
* @property EncryptionKey {AWSCodePipelinePipelineArtifactStoreEncryptionKey} Required: No. The encryption key AWS CodePipeline uses to encrypt the data in the artifact store, such
...
* @property Location {String} Required: Yes. The location where AWS CodePipeline stores artifacts for a pipeline, such as an S3
                  bucket.
* @property Type {String} Required: Yes. The type of the artifact store, such as Amazon S3. For valid values, see ArtifactStore in the
                     AWS CodePipeline API Reference.
*/
...
/** 
* @property Id {String} Required: Yes. The ID of the key. For an AWS KMS key, specify the key ID or key Amazon Resource
                  Number (ARN).
* @property Type {String} Required: Yes. The type of encryption key, such as KMS. For valid values, see
...
/** 
* @property Reason {String} Required: Yes. An explanation of why the transition between two stages of a pipeline was
                  disabled.
...
* @property Configuration {Object} Required: No. The action's configuration. These are key-value pairs that specify input values
                  for an action.
* @property InputArtifacts {AWSCodePipelinePipelineStagesActionsInputArtifacts} Required: No. The name or ID of the artifact that the action consumes, such as a test or
                  build artifact.
* @property Name {String} Required: Yes. The action name.
* @property OutputArtifacts {AWSCodePipelinePipelineStagesActionsOutputArtifacts} Required: No. The artifact name or ID that is a result of the action, such as a test or build
                  artifact.
* @property RoleArn {String} Required: No. The Amazon Resource Name (ARN) of a service role that the action uses. The
...
/** 
* @property Category {String} Required: Yes. A category that defines which action type the owner (the entitiy that performs
                  ...
                  you can specify for the Provider property. For valid values, see
                     ActionTypeId in the
                     AWS CodePipeline API Reference.
* @property Owner {String} Required: Yes. The entity that performs the action. For valid values, see ActionTypeId in the
                     AWS CodePipeline API Reference.
* @property Provider {String} Required: Yes. The service provider that the action calls. The providers that you can specify
...
/** 
* @property Name {String} Required: Yes. The name of the artifact that the AWS CodePipeline action works on, such as My
...
/** 
* @property Name {String} Required: Yes. The name of the artifact that is the result of an AWS CodePipeline action, such as
...
* @property Type {String} Required: Yes. The type of gate declaration. For valid values, see BlockerDeclaration in
...
/** 
* @property ComplianceResourceId {String} Required: No. The ID of an AWS resource that you want AWS Config to evaluate against a rule. If you
            specify an ID, you must also specify a resource type for the
              ComplianceResourceTypes property. 
* @property ComplianceResourceTypes {String} Required: Conditional. The types of AWS resources that you want AWS Config to evaluate against the rule. If you
            specify the ComplianceResourceId property, specify only one resource
            type.
* @property TagKey {String} Required: Conditional. The tag key that is applied to the AWS resources that you want AWS Config to evaluate
            against the rule.
* @property TagValue {String} Required: Conditional. The tag value that is applied to the AWS resources that you want AWS Config to evaluate
            against the rule.
*/
...
/** 
* @property Owner {String} Required: Yes. Indicates who owns and manages the AWS Config rule. For valid values, see the Source data type in the
              AWS Config API Reference.
* @property SourceDetails {AWSConfigConfigRuleSourceSourceDetails} Required: No. Provides the source and type of event that triggers AWS Config to evaluate your AWS
            resources.
* @property SourceIdentifier {String} Required: Yes. For AWS managed rules, the identifier of the rule. For a list of identifiers, see
              AWS Managed
...
/** 
* @property EventSource {String} Required: Yes. The source, such as an AWS service, that generate events, triggering AWS Config to
            evaluate your AWS resources. For valid values, see the SourceDetail data type in the
              AWS Config API Reference.
* @property MessageType {String} Required: Yes. The type of Amazon Simple Notification Service (Amazon SNS) message that triggers AWS Config to run an
...
/** 
* @property AllSupported {Boolean} Required: No. Indicates whether to record all supported resource types. If you specify this
            property, do not specify the ResourceTypes property.
* @property IncludeGlobalResourceTypes {Boolean} Required: No. Indicates whether AWS Config records all supported global resource types. When AWS Config
            ...
            enable this property.NoteIf you set this property to true, you must set the
              ...
              true.
* @property ResourceTypes {String} Required: No. A list of valid AWS resource types to include in this recording group, such as
              AWS::EC2::Instance or
...
/** 
* @property DeliveryFrequency {String} Required: No. The frequency with which AWS Config delivers configuration snapshots. For valid
...
/** 
* @property Key {String} Required: Yes. Specifies the name of a parameter attribute. To view parameter attributes, see
...
/** 
* @property Key {String} Required: Yes. Specifies the name of a field for a particular object. To view fields for a
                  data pipeline object, see Pipeline Object Reference in the
                     AWS Data Pipeline Developer Guide.
* @property RefValue {String} Required: Conditional. A field value that you specify as an identifier of another object in the same
...
* @property StringValue {String} Required: Conditional. A field value that you specify as a string. To view valid values for a
...
/** 
* @property AttributeName {String} Required: Yes. The name of an attribute. Attribute names can be 1 – 255 characters long
                  and have no character restrictions.
* @property AttributeType {String} Required: Yes. The data type for the attribute. You can specify S for string
...
/** 
* @property IndexName {String} Required: Yes. The name of the global secondary index. The index name can be 3 – 255
                  characters long and have no character restrictions.
* @property KeySchema {DynamoDBKeySchema} Required: Yes. The complete index key schema for the global secondary index, which consists of
                  one or more pairs of attribute names and key types.
* @property Projection {DynamoDBProjectionObject} Required: Yes. Attributes that are copied (projected) from the source table into the index.
...
/** 
* @property AttributeName {String} Required: Yes. The attribute name that is used as the primary key for this table. Primary key
                  element names can be 1 – 255 characters long and have no character
                  restrictions.
* @property KeyType {String} Required: Yes. Represents the attribute data, consisting of the data type and the attribute
...
/** 
* @property IndexName {String} Required: Yes. The name of the local secondary index. The index name can be 3 – 255
                  characters long and have no character restrictions.
* @property KeySchema {DynamoDBKeySchema} Required: Yes. The complete index key schema for the local secondary index, which consists of
...
/** 
* @property NonKeyAttributes {String} Required: No. The non-key attribute names that are projected into the index.For local secondary indexes, the total count of NonKeyAttributes
...
* @property ProjectionType {String} Required: No. The set of attributes that are projected into the index:Only the index and primary keys are projected into the
...
* @property KEYS_ONLY {undefined} Required: undefined. Only the index and primary keys are projected into the
                              index.
* @property INCLUDE {undefined} Required: undefined. Only the specified table attributes are projected into the index.
                              The list of projected attributes are in
                              NonKeyAttributes.
...
/** 
* @property ReadCapacityUnits {Number} Required: Yes. Sets the desired minimum number of consistent reads of items (up to 1KB in
                  size) per second for the specified table before Amazon DynamoDB balances the
                  load.
* @property WriteCapacityUnits {Number} Required: Yes. Sets the desired minimum number of consistent writes of items (up to 1KB in
                  size) per second for the specified table before Amazon DynamoDB balances the
                  load.
*/
...
/** 
* @property StreamViewType {String} Required: Yes. Determines the information that the stream captures when an item in the table
...
/** 
* @property DeleteOnTermination {Boolean} Required: No. Determines whether to delete the volume on instance termination. The default
                  value is true.
* @property Encrypted {Boolean} Required: No. Indicates whether the volume is encrypted. Encrypted Amazon EBS volumes can only be
...
* @property Iops {Number} Required: Conditional. The number of I/O operations per second (IOPS) that the volume supports. This can be an integer
               from 100 – 2000.
* @property SnapshotId {String} Required: Conditional. The snapshot ID of the volume to use to create a block device.
* @property VolumeSize {String} Required: Conditional. The volume size, in gibibytes (GiB). This can be a number from 1 – 1024.
                  If the volume type is io1, the minimum value is 10.Update requires: Some interruptions
* @property VolumeType {String} Required: No. The volume type. You can specify standard, io1, or
                     gp2. If you set the type to io1, you must also set
                  the Iops property. For more information about these values
                  and the default value, see CreateVolume in
...
* @property VolumeId {String} Required: Yes. The ID of the Amazon EBS volume. The volume and instance must be within the same Availability Zone
...
/** 
* @property AssociatePublicIpAddress {Boolean} Required: No. Indicates whether the network interface receives a public IP address. You can
...
* @property PrivateIpAddress {String} Required: No. Assigns a single private IP address to the network interface, which is used as
                  the primary private IP address. If you want to specify multiple private IP
                  address, use the PrivateIpAddresses property.
* @property PrivateIpAddresses {EC2NetworkInterfacePrivateIPSpecification} Required: No. Assigns a list of private IP addresses to the network interface. You can
...
* @property SecondaryPrivateIpAddressCount {Number} Required: No. The number of secondary private IP addresses that Amazon EC2 auto assigns to the
...
* @property Primary {Boolean} Required: Yes. Sets the private IP address as the primary private address. You can set only
...
* @property FromPort {Number} Required: No. The start of port range for the TCP and UDP protocols, or an ICMP type number.
                  An ICMP type number of -1 indicates a wildcard (i.e., any ICMP type
                  number).
* @property IpProtocol {String} Required: Yes. An IP protocol name or number. For valid values, go to the IpProtocol parameter
                  in AuthorizeSecurityGroupIngress
* @property SourceSecurityGroupId {String} Required: Conditional. For VPC security groups only. Specifies the ID of the
...
* @property SourceSecurityGroupName {String} Required: Conditional. For non-VPC security groups only. Specifies the name of
...
* @property SourceSecurityGroupOwnerId {String} Required: Conditional. Specifies the AWS Account ID of the owner of the Amazon EC2 Security Group that
                  is specified in the SourceSecurityGroupName property.
* @property ToPort {Number} Required: No. The end of port range for the TCP and UDP protocols, or an ICMP code. An ICMP
...
/** 
* @property AllocationStrategy {String} Required: No. Indicates how to allocate the target capacity across the Spot pools that you
                  specified in the Spot fleet request. For valid values, see SpotFleetRequestConfigData in the
                     Amazon EC2 API Reference.
* @property ExcessCapacityTerminationPolicy {String} Required: No. Indicates whether running Spot instances are terminated if you decrease the
                  ...
                  fleet. For valid values, see SpotFleetRequestConfigData in the
                     Amazon EC2 API Reference.
* @property IamFleetRole {String} Required: Yes. The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that grants the
...
* @property SpotPrice {String} Required: Yes. The bid price per unit hour. For more information, see How Spot Fleet Works in the
                     Amazon EC2 User Guide for Linux Instances.
* @property TargetCapacity {Number} Required: Yes. The number of units to request for the spot fleet. You can choose to set the
...
* @property TerminateInstancesWithExpiration {Boolean} Required: No. Indicates whether running Spot instances are terminated when the Spot fleet
                  request expires.
* @property ValidFrom {String} Required: No. The start date and time of the request, in UTC format
                     (YYYY-MM-DDTHH:MM:SSZ).
                  By default, Amazon Elastic Compute Cloud (Amazon EC2 ) starts fulfilling the request immediately.
* @property ValidUntil {String} Required: No. The end date and time of the request, in UTC format
                     (YYYY-MM-DDTHH:MM:SSZ).
...
* @property EbsOptimized {Boolean} Required: No. Indicates whether the instances are optimized for Amazon Elastic Block Store (Amazon EBS) I/O. This
...
* @property IamInstanceProfile {AmazonElasticComputeCloudSpotFleetSpotFleetRequestConfigDataLaunchSpecificationsIamInstanceProfile} Required: No. Defines the AWS Identity and Access Management (IAM) instance profile to associate with the
                  instances.
* @property ImageId {String} Required: Yes. The unique ID of the Amazon Machine Image (AMI) to launch on the
                  instances.
...
* @property Placement {AmazonElasticComputeCloudSpotFleetSpotFleetRequestConfigDataLaunchSpecificationsPlacement} Required: No. Defines a placement group, which is a logical grouping of instances within a
                  single Availability Zone (AZ).
* @property RamdiskId {String} Required: No. The ID of the RAM disk to select. Some kernels require additional drivers at
...
* @property WeightedCapacity {Number} Required: No. The number of units provided by the specified instance type. These units are
...
/** 
* @property DeviceName {String} Required: Yes. The name of the device within the EC2 instance, such as /dev/dsh
                  or xvdh.
...
* @property NoDevice {Boolean} Required: No. Suppresses the specified device that is included in the block device mapping of
...
* @property Encrypted {Boolean} Required: No. Indicates whether the EBS volume is encrypted. Encrypted Amazon EBS volumes can be
                  attached only to instances that support Amazon EBS encryption.
* @property Iops {Number} Required: No. The number of I/O operations per second (IOPS) that the volume supports. For
...
* @property VolumeSize {Number} Required: Conditional. The volume size, in Gibibytes (GiB). For more information about specifying the
            volume size, see VolumeSize
            for the EbsBlockDevice action in the
            Amazon EC2 API Reference.
* @property VolumeType {String} Required: No. The volume type. For more information about specifying the volume type, see
                     VolumeType for the
...
/** 
* @property Arn {String} Required: No. The Amazon Resource Name (ARN) of the instance profile to associate with the
...
* @property DeleteOnTermination {Boolean} Required: No. Indicates whether to delete the network interface when the instance
                  terminates.
* @property Description {String} Required: No. The description of this network interface.
...
* @property PrivateIpAddresses {AmazonElasticComputeCloudSpotFleetSpotFleetRequestConfigDataLaunchSpecificationsNetworkInterfacesPrivateIpAddresses} Required: No. One or more private IP addresses to assign to the network interface. You can
                  designate only one private IP address as primary.
* @property SecondaryPrivateIpAddressCount {Number} Required: No. The number of secondary private IP addresses that Amazon Elastic Compute Cloud (Amazon EC2)
...
/** 
* @property Primary {Boolean} Required: No. Indicates whether the private IP address is the primary private IP address. You
...
* @property ContainerPort {Number} Required: Yes. The port number on the container to direct load balancer traffic to. Your
...
/** 
* @property Command {String} Required: No. The CMD value to pass to the container. For more information
                        about the Docker CMD parameter, see https://docs.docker.com/reference/builder/#cmd.
...
* @property EntryPoint {String} Required: No. The ENTRYPOINT value to pass to the container. For more
...
* @property Image {String} Required: Yes. The image to use for a container, which is passed directly to the Docker
                        daemon. You can use images in the Docker Hub registry or specify other
                        repositories
                            (repository-url/image:tag).
* @property Links {String} Required: No. The name of another container to connect to. With links, containers can
                        communicate with each other without using port mappings.
* @property LogConfiguration {AmazonEC2ContainerServiceTaskDefinitionContainerDefinitionsLogConfiguration} Required: No. Configures a custom log driver for the container. For more information, see the
...
* @property PortMappings {AmazonEC2ContainerServiceTaskDefinitionContainerDefinitionsPortMappings} Required: No. A mapping of the container port to a host port. Port mappings enable
...
/** 
* @property ContainerPath {String} Required: Yes. The path on the container that indicates where you want to mount the
                  volume.
* @property SourceVolume {String} Required: Yes. The name of the volume to mount.
* @property ReadOnly {Boolean} Required: No. Indicates whether the container can write to the volume. If you specify
...
* @property HostPort {Number} Required: No. The host port number on the container instance that you want to reserve for
                  your container. You can specify a non-reserved host port for your container port
                  mapping, or you can omit the host port (or set it to 0). If you
                  specify a container port but no host port, your container port is automatically
                  assigned a host port in the 49153 to 65535 port
                  range.Do not specify a host port in the 49153 to 65535 port
                  range; these ports are reserved for automatic assignment. Other reserved ports
                  include 22 for SSH, the Docker ports 2375 and
                     2376, and the Amazon EC2 Container Service container agent port 51678.
                  In addition, do not specify a host port that is being used for a task; that port
...
* @property Name {String} Required: No. The type of ulimit. For valid values, see the name content for the
...
/** 
* @property Name {String} Required: Yes. The name of the volume. To specify mount points in your container definitions,
                  use the value of this property.
* @property Host {AmazonEC2ContainerServiceTaskDefinitionVolumesHost} Required: No. Determines whether your data volume persists on the host container instance and
...
/** 
* @property SourcePath {String} Required: No. The data volume path on the host container instance.If you don't specify this parameter, the Docker daemon assigns a path for you,
...
/** 
* @property Key {String} Required: No. The key name of the tag. You can specify a value that is from 1 to 128 Unicode
                  characters in length, but you cannot use the prefix aws:.
* @property Value {String} Required: No. The value of the tag key. You can specify a value that is from 0 to 128 Unicode
...
/** 
* @property Name {String} Required: No. The name of the environment tier. You can specify WebServer or
                     Worker.Update requires: Replacement
* @property Type {String} Required: No. The type of this environment tier. You can specify Standard for
                  the WebServer tier or SQS/HTTP for the
                     Worker tier.Update requires: Replacement
...
/** 
* @property Namespace {String} Required: Yes. A unique namespace identifying the option's associated AWS resource. For a list
                  of namespaces that you can use, see Configuration Options in the AWS Elastic Beanstalk
                     Developer Guide.
* @property OptionName {String} Required: Yes. The name of the configuration option. For a list of options that you can use,
...
/** 
* @property ApplicationName {String} Required: Yes. The name of the Elastic Beanstalk application that contains the configuration template that
                  you want to use.
...
/** 
* @property EmitInterval {Number} Required: No. The interval for publishing access logs in minutes. You can specify an interval
...
* @property S3BucketPrefix {String} Required: No. A prefix for the all log object keys, such as
...
* @property PolicyName {String} Required: Yes. The name of the policy being created. The name must be unique within the set of
...
* @property Timeout {Number} Required: No. The time in seconds after the load balancer closes all connections to a
...
/** 
* @property IdleTimeout {Number} Required: Yes. The time (in seconds) that a connection to the load balancer can remain idle,
...
/** 
* @property HealthyThreshold {String} Required: Yes. Specifies the number of consecutive health probe successes required before moving the instance to
                  the Healthy state.
* @property Interval {String} Required: Yes. Specifies the approximate interval, in seconds, between health checks of an individual
                  instance.
* @property Target {String} Required: Yes. Specifies the instance's protocol and port to check. The protocol can be TCP,
                  HTTP, HTTPS, or SSL. The range of valid ports is 1 through 65535.NoteFor TCP and SSL, you specify a port pair. For example, you can specify
                     ...
                     Unicode characters.
* @property Timeout {String} Required: Yes. Specifies the amount of time, in seconds, during which no response means a failed health probe.
                  This value must be less than the value for Interval.
* @property UnhealthyThreshold {String} Required: Yes. Specifies the number of consecutive health probe failures required before moving the instance to
                  the Unhealthy state.
*/
...
/** 
* @property CookieExpirationPeriod {String} Required: No. The time period, in seconds, after which the cookie should be considered stale. If this parameter
                  isn't specified, the sticky session will last for the duration of the browser session.
* @property PolicyName {undefined} Required: undefined. The name of the policy being created. The name must be unique within the set of
                  policies for this load balancer.NoteTo associate this policy with a listener, include the policy name in the
...
/** 
* @property InstancePort {String} Required: Yes. Specifies the TCP port on which the instance server is listening. This property cannot be modified
                  for the life of the load balancer.
* @property InstanceProtocol {String} Required: No. Specifies the protocol to use for routing traffic to back-end instances—HTTP, HTTPS, TCP, or
                  SSL. This property cannot be modified for the life of the load balancer.NoteIf the front-end protocol is HTTP or HTTPS, InstanceProtocol has to
                           be at the same protocol layer, i.e., HTTP or HTTPS. Likewise, if the front-end protocol is
                           TCP or SSL, InstanceProtocol has to be TCP or SSL.If there is another listener with the same InstancePort whose
                           ...
                           HTTP or TCP, the listener's InstanceProtocol must be either HTTP or
                           TCP.
* @property LoadBalancerPort {String} Required: Yes. Specifies the external load balancer port number. This property cannot be modified for the life of
                  the load balancer.
...
* @property Protocol {String} Required: Yes. Specifies the load balancer transport protocol to use for routing — HTTP, HTTPS, TCP or SSL.
                  This property cannot be modified for the life of the load balancer.
* @property SSLCertificateId {String} Required: No. The ARN of the SSL certificate to use. For more information about SSL certificates, see Managing
                     Server Certificates in the AWS Identity and Access Management documentation.
*/
...
/** 
* @property Attributes {Object} Required: Yes. A list of arbitrary attributes for this policy. If you don't need to specify
                  any policy attributes, specify an empty list ([]).
* @property InstancePorts {String} Required: No. A list of instance ports for the policy. These are the ports associated with the back-end
                  server.
...
* @property PolicyType {String} Required: Yes. The name of the policy type for this policy. This must be one of the types reported by the Elastic Load Balancing
...
/** 
* @property EBSEnabled {Boolean} Required: No. Specifies whether Amazon EBS volumes are attached to data nodes in the Amazon ES
            domain.
* @property Iops {Number} Required: No. The number of I/O operations per second (IOPS) that the volume supports. This
            property applies only to the Provisioned IOPS (SSD) EBS volume type.
* @property VolumeSize {Number} Required: No. The size of the EBS volume for each data node. The minimum and maximum size of an
...
* @property VolumeType {String} Required: No. The EBS volume type to use with the Amazon ES domain, such as standard,
...
/** 
* @property DedicatedMasterCount {Number} Required: No. The number of instances to use for the master node.If you specify this property, you must specify true for the
              DedicatedMasterEnabled property
* @property DedicatedMasterEnabled {Boolean} Required: No. Indicates whether to use a dedicated master node for the Amazon ES domain. A
...
* @property DedicatedMasterType {String} Required: No. The hardware configuration of the computer that hosts the dedicated master node,
...
* @property InstanceType {String} Required: No. The instance type for your data nodes, such as m3.medium.elasticsearch.
            For valid values, see Configuring Amazon ES Domains in the
            Amazon Elasticsearch Service Developer Guide.
* @property ZoneAwarenessEnabled {Boolean} Required: No. Indicates whether to enable zone awareness for the Amazon ES domain. When you enable
...
/** 
* @property AutomatedSnapshotStartHour {Number} Required: No. The hour in UTC during which the service takes an automated daily snapshot of the
...
/** 
* @property AdditionalInfo {Map} Required: No. Metadata about third-party applications that third-party vendors use for testing
            purposes.
* @property Args {String} Required: No. Arguments that Amazon EMR passes to the application.
* @property Name {String} Required: No. The name of the application to add to your cluster, such as Hadoop or
              Hive. For valid values, see the Applications parameter in the Amazon Elastic MapReduce API Reference.
...
* @property Path {String} Required: Yes. The location of the script that Amazon EMR runs during a bootstrap action. Specify a
...
/** 
* @property Classification {String} Required: No. The name of an application-specific configuration file. For more information see,
              Configuring Applications in the Amazon Elastic MapReduce Release
              Guide.
* @property ConfigurationProperties {Map} Required: No. The settings that you want to change in the application-specific configuration file.
            For more information see, Configuring Applications in the Amazon Elastic MapReduce Release
              Guide.
* @property Configurations {AmazonElasticMapReduceClusterConfiguration} Required: No. A list of configurations to apply to this configuration. You can nest configurations
            so that a single configuration can have its own configurations. In other words, you can
            configure a configuration. For more information see, Configuring Applications in the Amazon Elastic MapReduce Release
              Guide.
*/
...
/** 
* @property AdditionalMasterSecurityGroups {String} Required: No. A list of additional EC2 security group IDs to assign to the master instance (master
...
* @property AdditionalSlaveSecurityGroups {String} Required: No. A list of additional EC2 security group IDs to assign to the slave instances (slave
...
* @property Ec2KeyName {String} Required: No. The name of an Amazon Elastic Compute Cloud (Amazon EC2) key pair, which you can use to access the instances
...
* @property EmrManagedMasterSecurityGroup {String} Required: No. The ID of an EC2 security group (managed by Amazon EMR) that is assigned to the master
            instance (master node) in your Amazon EMR cluster.
* @property EmrManagedSlaveSecurityGroup {String} Required: No. The ID of an EC2 security group (managed by Amazon EMR) that is assigned to the slave
            instances (slave nodes) in your Amazon EMR cluster.
* @property HadoopVersion {String} Required: No. The Hadoop version for the job flow. For valid values, see the HadoopVersion parameter in
            the Amazon Elastic MapReduce API Reference.
...
* @property ServiceAccessSecurityGroup {String} Required: No. The ID of an EC2 security group (managed by Amazon EMR) that services use to access
            clusters in private subnets.
* @property TerminationProtected {Boolean} Required: No. Indicates whether to prevent the EC2 instances from being terminated by an API call
...
* @property InstanceType {String} Required: Yes. The EC2 instance type for all instances in the instance group. For more information,
            see Instance Configurations in the Amazon EMR Management
            Guide.
* @property Market {String} Required: No. The type of marketplace from which your instances are provisioned into this group,
...
/** 
* @property Args {String} Required: No. A list of command line arguments passed to the JAR file's main function when the
            function is executed.
* @property Jar {String} Required: Yes. A path to the JAR file that Amazon EMR runs for the job flow step.
* @property MainClass {String} Required: No. The name of the main class in the specified JAR file. If you don't specify a value,
            you must specify a main class in the JAR file's manifest file.
* @property StepProperties {AmazonElasticMapReduceStepHadoopJarStepConfigKeyValue} Required: No. A list of Java properties that are set when the job flow step runs. You can use
...
* @property Message {String} Required: Conditional. A text message that GameLift displays for the Terminal routing
            type.
* @property Type {String} Required: Yes. The type of routing strategy. For the SIMPLE type, traffic is routed to
...
* @property RoleArn {String} Required: Yes. An AWS Identity and Access Management (IAM) role Amazon Resource Name (ARN) that GameLift can assume to
...
/** 
* @property FromPort {Number} Required: Yes. The starting value for a range of allowed port numbers. This value must be lower
            than the ToPort value.
* @property IpRange {String} Required: Yes. The range of allowed IP addresses in CIDR notation.
* @property Protocol {String} Required: Yes. The network communication protocol that is used by the fleet. For valid values, see
            the IpPermission data type in the
              Amazon GameLift API Reference.
* @property ToPort {Number} Required: Yes. The ending value for a range of allowed port numbers. This value must be higher than
            the FromPort value. 
*/
...
/** 
* @property PolicyDocument {Object} Required: Yes. A policy document that describes what actions are allowed on which
                  resources.Update requires: No interruption
...
* @property PasswordResetRequired {Boolean} Required: No. Specifies whether the user is required to set a new password the next time the
...
/** 
* @property CpuThreshold {Number} Required: No. The percentage of CPU utilization that triggers the starting or stopping of
                  instances (scaling).
* @property IgnoreMetricsTime {Number} Required: No. The amount of time (in minutes) after a scaling event occurs that AWS OpsWorks should
                  ignore metrics and not start any additional scaling events.
* @property InstanceCount {Number} Required: No. The number of instances to add or remove when the load exceeds a
                  threshold.
* @property LoadThreshold {Number} Required: No. The degree of system load that triggers the starting or stopping of instances
                  (scaling). For more information about how load is computed, see Load
                     (computing).
* @property MemoryThreshold {Number} Required: No. The percentage of memory consumption that triggers the starting or stopping of
                  instances (scaling).
* @property ThresholdsWaitTime {Number} Required: No. The amount of time, in minutes, that the load must exceed a threshold before
...
/** 
* @property DelayUntilElbConnectionsDrained {Boolean} Required: No. Indicates whether to wait for connections to drain from the Elastic Load Balancing load
                  balancers.
* @property ExecutionTimeout {Number} Required: No. The time, in seconds, that AWS OpsWorks waits after a shutdown event has been
...
/** 
* @property DownScaling {AWSOpsWorksAutoScalingThresholdsType} Required: No. The threshold below which the instances are scaled down (stopped). If the load
...
* @property UpScaling {AWSOpsWorksAutoScalingThresholdsType} Required: No. The threshold above which the instances are scaled up (added). If the load
...
/** 
* @property Configure {String} Required: No. Custom recipe names to be run following a Configure event. The event occurs on
                  all of the stack's instances when an instance enters or leaves the online
                  state.
* @property Deploy {String} Required: No. Custom recipe names to be run following a Deploy event. The event occurs when
                  you run a deploy command, typically to deploy an application to a set
                  of application server instances.
* @property Setup {String} Required: No. Custom recipe names to be run following a Setup event. This event
                  occurs on a new instance after it successfully boots.
* @property Shutdown {String} Required: No. Custom recipe names to be run following a Shutdown event. This
...
* @property Undeploy {String} Required: No. Custom recipe names to be run following a Undeploy event. This
...
/** 
* @property Password {String} Required: No. This parameter depends on the repository type. For Amazon S3 bundles, set
...
* @property Revision {String} Required: No. The application's version. With AWS OpsWorks, you can deploy new versions of an
                  ...
                  deployed.
* @property SshKey {String} Required: No. The repository's SSH key. For more information, see Using Git Repository SSH Keys in the AWS OpsWorks User Guide.To pass in an SSH key as a parameter, see the following
                  example:
* @property Type {String} Required: No. The repository type.
* @property Url {String} Required: No. The source URL.
* @property Username {String} Required: No. This parameter depends on the repository type. For Amazon S3 bundles, set
...
/** 
* @property Key {String} Required: Yes. The name of the environment variable, which can consist of up to 64 characters.
                  You can use upper and lowercase letters, numbers, and underscores (_), but the
                  name must start with a letter or underscore.
* @property Secure {Boolean} Required: No. Indicates whether the value of the environment variable is concealed, such as
                  with a DescribeApps
                  response. To conceal an environment variable's value, set the value to
                     true.
* @property Value {String} Required: Yes. The value of the environment variable, which can be empty. You can specify a
...
* @property PrivateKey {String} Required: Yes. The private key; the contents of the certificate's
                     domain.kex file.
*/
...
/** 
* @property Iops {Number} Required: Conditional. The number of I/O operations per second (IOPS) to provision for the
                  volume.
...
* @property VolumeType {String} Required: No. The type of volume, such as magnetic or SSD. For valid values, see VolumeConfiguration in
...
/** 
* @property Key {String} Required: Yes. The key name of the tag. You can specify a value that is 1 to 128 Unicode
                  characters in length and cannot be prefixed with aws:. You can use
                  any of the following characters: the set of Unicode letters, digits, whitespace,
                     _, ., /, =, +,
                  and -.
* @property Value {String} Required: Yes. The value for the tag. You can specify a value that is 1 to 128 Unicode
                  characters in length and cannot be prefixed with aws:. You can use
                  any of the following characters: the set of Unicode letters, digits, whitespace,
                     _, ., /, =, +,
                  and -.
...
/** 
* @property DBSecurityGroupMemberships {String} Required: No. A list of database security group names for this option. If the option requires
            ...
            property.
* @property OptionName {String} Required: Yes. The name of the option. For more information about options, see Working with Option
...
* @property VpcSecurityGroupMemberships {String} Required: No. A list of VPC security group IDs for this option. If the option requires access to a
...
/** 
* @property CIDRIP {String} Required: No. The IP range to authorize.For an overview of CIDR ranges, go to the Wikipedia
                  Tutorial.Update requires: Replacement
* @property EC2SecurityGroupId {String} Required: No. Id of the VPC or EC2 Security Group to authorize.For VPC DB Security Groups, use EC2SecurityGroupId. For EC2 Security Groups, use
                  EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId.Update requires: Replacement
* @property EC2SecurityGroupName {String} Required: No. Name of the EC2 Security Group to authorize.For VPC DB Security Groups, use EC2SecurityGroupId. For EC2 Security Groups, use
                  EC2SecurityGroupOwnerId and either EC2SecurityGroupName or EC2SecurityGroupId.Update requires: Replacement
* @property EC2SecurityGroupOwnerId {String} Required: No. AWS Account Number of the owner of the EC2 Security Group specified in the EC2SecurityGroupName
...
* @property EvaluateTargetHealth {Boolean} Required: No. Whether Amazon Route 53 checks the health of the resource record sets in the alias target
...
* @property HostedZoneId {String} Required: Yes. The hosted zone ID. For load balancers, use the canonical hosted zone ID of the
                  load balancer. For Amazon S3, use the hosted zone ID for your bucket's website
                  endpoint. For CloudFront, use Z2FDTNDATAQYW2. For examples, see Example: Creating Alias Resource
                     Record Sets in the Amazon Route 53 API Reference.
*/
...
/** 
* @property ContinentCode {String} Required: Conditional. All DNS queries from the continent that you specified are routed to this
                  ...
                  Amazon Route 53 API Reference.
* @property CountryCode {String} Required: Conditional. All DNS queries from the country that you specified are routed to this resource
                  ...
                  Amazon Route 53 API Reference.
* @property SubdivisionCode {String} Required: No. If you specified US for the country code, you can specify a state
...
/** 
* @property FailureThreshold {Number} Required: No. The number of consecutive health checks that an endpoint must pass or fail for
...
* @property FullyQualifiedDomainName {String} Required: Conditional. If you specified the IPAddress property, the value that you want
                  ...
                  the endpoint.
* @property IPAddress {String} Required: No. The IPv4 IP address of the endpoint on which you want Amazon Route 53 to
...
* @property Port {Number} Required: Conditional. The port on the endpoint on which you want Amazon Route 53 to perform health
                  checks.
* @property RequestInterval {Number} Required: No. The number of seconds between the time that Amazon Route 53 gets a response from your
                  ...
                  health checker makes requests at this interval. For valid values, see the RequestInterval element in the
                     Amazon Route 53 API Reference.
* @property ResourcePath {String} Required: No. The path that you want Amazon Route 53 to request when performing health checks. The path
...
* @property SearchString {String} Required: No. If the value of the Type property is HTTP_STR_MATCH
...
* @property Type {String} Required: Yes. The type of health check that you want to create, which indicates how Amazon Route 53
...
* @property VPCRegion {String} Required: Yes. The region in which the Amazon VPC was created as specified in the
                     VPCId property.
*/
...
/** 
* @property AllowedHeaders {String} Required: No. Headers that are specified in the Access-Control-Request-Headers
                  ...
                  allowed.
* @property AllowedMethods {String} Required: Yes. An HTTP method that you allow the origin to execute. The valid values are
                     GET, PUT, HEAD, POST, and
                     DELETE.
* @property AllowedOrigins {String} Required: Yes. An origin that you allow to send cross-domain requests.
* @property ExposedHeaders {String} Required: No. One or more headers in the response that are accessible to client applications
                  (for example, from a JavaScript XMLHttpRequest object).
* @property Id {String} Required: No. A unique identifier for this rule. The value cannot be more than 255
                  characters.
* @property MaxAge {Number} Required: No. The time in seconds that your browser is to cache the preflight response for
...
/** 
* @property ExpirationDate {String} Required: Conditional. Indicates when objects are deleted from Amazon S3 and Amazon Glacier. The date value must be
                  ...
                  time.
* @property ExpirationInDays {Number} Required: Conditional. Indicates the number of days after creation when objects are deleted from Amazon S3
...
* @property Id {String} Required: No. A unique identifier for this rule. The value cannot be more than 255
                  characters.
* @property NoncurrentVersionExpirationInDays {Number} Required: Conditional. For buckets with versioning enabled (or suspended), specifies the time, in
...
* @property Prefix {String} Required: No. Object key prefix that identifies one or more objects to which this rule
                  applies.
* @property Status {String} Required: Yes. Specify either Enabled or Disabled. If you specify
...
/** 
* @property StorageClass {String} Required: Yes. The storage class to which you want the object to transition, such as
                     GLACIER. For valid values, see the StorageClass
                  request element of the PUT
                     Bucket lifecycle action in the
                  Amazon Simple Storage Service API Reference.
* @property TransitionInDays {Number} Required: Yes. The number of days between the time that a new version of the object is
...
* @property StorageClass {String} Required: Yes. The storage class to which you want the object to transition, such as
                  ...
                  request element of the PUT
                     Bucket lifecycle action in the
                  Amazon Simple Storage Service API Reference.
* @property TransitionDate {String} Required: Conditional. Indicates when objects are transitioned to the specified storage class. The
                  date value must be in ISO 8601 format. The time is always midnight UTC.
* @property TransitionInDays {Number} Required: Conditional. Indicates the number of days after creation when objects are transitioned to
...
/** 
* @property DestinationBucketName {String} Required: No. The name of an Amazon S3 bucket where Amazon S3 store server access log files. You can
...
* @property LogFilePrefix {String} Required: No. A prefix for the all log object keys. If you store log files from multiple Amazon S3
...
/** 
* @property LambdaConfigurations {AmazonSimpleStorageServiceNotificationConfigurationLambdaConfigurations} Required: No. The AWS Lambda functions to invoke and the events for which to invoke the
                  functions.
* @property QueueConfigurations {AmazonSimpleStorageServiceNotificationConfigurationQueueConfigurations} Required: No. The Amazon Simple Queue Service queues to publish messages to and the events for which to publish
                  messages.
* @property TopicConfigurations {AmazonS3NotificationConfigurationTopicConfigurations} Required: No. The topic to which notifications are sent and the events for which notification
                  are generated.
*/
...
/** 
* @property S3Key {AmazonS3NotificationConfigurationConfigFilterS3Key} Required: Yes. Amazon S3 filtering rules that describe for which object key names to send
                  notifications.
*/
...
/** 
* @property Rules {AmazonS3NotificationConfigurationConfigFilterS3KeyRules} Required: Yes. The object key name to filter on and whether to filter on the suffix or prefix
                  of the key name.
*/
...
/** 
* @property Name {String} Required: Yes. Whether the filter matches the prefix or suffix of object key names. For valid
...
/** 
* @property Event {String} Required: Yes. The S3 bucket event for which to invoke the Lambda function.
                  For more information, see Supported Event Types in the
                  Amazon Simple Storage Service Developer Guide.
* @property Filter {AmazonS3NotificationConfigurationConfigFilter} Required: No. The filtering rules that determine which objects invoke the Lambda function. For
                  example, you can create a filter so that only image files with a
                     .jpg extension invoke the function when they are added to
                  the S3 bucket.
* @property Function {String} Required: Yes. The Amazon Resource Name (ARN) of the Lambda function that Amazon S3 invokes when the
...
/** 
* @property Event {String} Required: Yes. The S3 bucket event about which you want to publish messages to Amazon Simple Queue Service (
                  Amazon SQS). For more information, see Supported Event Types in the
                  Amazon Simple Storage Service Developer Guide.
* @property Filter {AmazonS3NotificationConfigurationConfigFilter} Required: No. The filtering rules that determine for which objects to send notifications. For
                  ...
                  bucket.
* @property Queue {String} Required: Yes. The Amazon Resource Name (ARN) of the Amazon SQS queue that Amazon S3 publishes messages
...
/** 
* @property Event {String} Required: Yes. The Amazon Simple Storage Service (Amazon S3) bucket event about which to send notifications. For more
...
* @property Filter {AmazonS3NotificationConfigurationConfigFilter} Required: No. The filtering rules that determine for which objects to send notifications. For
                  ...
                  when image files with a .jpg extension are added to the
                  bucket.
* @property Topic {String} Required: Yes. The Amazon SNS topic Amazon Resource Name (ARN) to which Amazon S3 reports the specified
                  events.
*/
...
/** 
* @property Role {String} Required: Yes. The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that Amazon S3 assumes
...
* @property Rules {AmazonS3ReplicationConfigurationRules} Required: Yes. A replication rule that specifies which objects to replicate and where they are
                  stored.
*/
...
* @property Id {String} Required: No. A unique identifier for the rule. If you don't specify a value, AWS CloudFormation generates
                  a random ID.
* @property Prefix {String} Required: Yes. An object prefix. This rule applies to all Amazon S3 objects with this prefix. To
                  specify all objects in an S3 bucket, specify an empty string.
* @property Status {String} Required: Yes. Whether the rule is enabled. For valid values, see the Status
...
/** 
* @property Bucket {String} Required: Yes. The Amazon resource name (ARN) of an S3 bucket where Amazon S3 stores replicated
...
* @property StorageClass {String} Required: No. The storage class to use when replicating objects, such as standard or reduced
...
/** 
* @property Status {String} Required: Yes. The versioning state of an Amazon S3 bucket. If you enable versioning, you must
...
* @property RedirectAllRequestsTo {AmazonS3WebsiteConfigurationRedirectAllRequestsToProperty} Required: No. The redirect behavior for every request to this bucket's website endpoint.ImportantIf you specify this property, you cannot specify any other
                        property.
...
* @property Protocol {String} Required: No. Protocol to use (http or https) when redirecting
...
/** 
* @property RedirectRule {AmazonS3WebsiteConfigurationRoutingRulesRedirectRuleProperty} Required: Yes. Redirect requests to another host, to another page, or with another
                  protocol.
...
* @property ReplaceKeyPrefixWith {String} Required: No. The object key prefix to use in the redirect request. For example, to redirect
...
* @property ReplaceKeyWith {String} Required: No. The specific object key to use in the redirect request. For example, redirect
...
/** 
* @property HttpErrorCodeReturnedEquals {String} Required: Conditional. Applies this redirect if the error code equals this value in the event of an
                  error.
* @property KeyPrefixEquals {String} Required: Conditional. The object key name prefix when the redirect is applied. For example, to
...
/** 
* @property Endpoint {String} Required: Yes. The subscription's endpoint (format depends on the protocol). For more
                  information, see the Subscribe
                     Endpoint parameter in the
                  Amazon Simple Notification Service API Reference.
* @property Protocol {String} Required: Yes. The subscription's protocol. For more information, see the Subscribe Protocol parameter in
...
/** 
* @property deadLetterTargetArn {String} Required: No. The Amazon Resource Name (ARN) of the dead letter queue to which the messages are
            sent to after the maxReceiveCount value has been exceeded.
* @property maxReceiveCount {Number} Required: No. The number of times a message is delivered to the source queue before being sent to
...
/** 
* @property FieldToMatch {AWSWAFByteMatchSetByteMatchTuplesFieldToMatch} Required: Yes. The part of a web request that you want AWS WAF to search, such as a specific
                  header or a query string.
* @property PositionalConstraint {String} Required: Yes. How AWS WAF finds matches within the web request part in which you are searching.
                  For valid values, see the PositionalConstraint content for the ByteMatchTuple data type in
                  the AWS WAF API Reference.
* @property TargetString {String} Required: Conditional. The value that AWS WAF searches for. AWS CloudFormation base64 encodes this value before
                  ...
                  the AWS WAF API Reference.
* @property TargetStringBase64 {String} Required: Conditional. The base64-encoded value that AWS WAF searches for. AWS CloudFormation sends this value to
                  ...
                  type, you must specify HTTP methods such as DELETE, GET, HEAD, OPTIONS,
                     ...
                     TargetString content for the ByteMatchTuple data type in
                  the AWS WAF API Reference.
* @property TextTransformation {String} Required: Yes. Specifies how AWS WAF processes the target string value. Text transformations
...
/** 
* @property Data {String} Required: Conditional. If you specify HEADER for the Type property, the name
...
* @property Type {String} Required: Yes. The part of the web request in which AWS WAF searches for the target string. For
...
/** 
* @property Type {String} Required: Yes. The IP address type, such as IPV4. For valid values, see the
                     Type contents of the IPSetDescriptor data type
                  in the AWS WAF API Reference.
* @property Value {String} Required: Yes. An IP address (in CIDR notation) that AWS WAF permits, blocks, or counts. For
...
* @property Type {String} Required: Yes. The type of predicate in a rule, such as an IPSet
...
* @property FieldToMatch {AWSWAFByteMatchSetByteMatchTuplesFieldToMatch} Required: Yes. The part of a web request that you want AWS WAF to search, such as a specific
                  header or a query string.
* @property TextTransformation {String} Required: Yes. Text transformations eliminate some of the unusual formatting that attackers
...
/** 
* @property Type {String} Required: Yes. For actions that are associated with a rule, the action that AWS WAF takes when a
...
/** 
* @property Action {AWSWAFWebACLAction} Required: Yes. The action that Amazon CloudFront (CloudFront) or AWS WAF takes when a web request matches all
                  conditions in the rule, such as allow, block, or count the request.
* @property Priority {Number} Required: Yes. The order in which AWS WAF evaluates the rules in a web ACL. AWS WAF evaluates
...
* @property RuleId {String} Required: Yes. The ID of an AWS WAF rule to
